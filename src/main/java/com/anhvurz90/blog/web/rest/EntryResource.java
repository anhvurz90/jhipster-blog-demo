...
import com.anhvurz90.blog.repository.EntryRepository;
import com.anhvurz90.blog.repository.search.EntrySearchRepository;
...
public class EntryResource {
    ...
    public ResponseEntity<List<Entry>> getAllEntries(Pageable pageable)
        ...
        Page<Entry> page = 
        		entryRepository.findByBlogUserLoginOrderByDateDesc(
